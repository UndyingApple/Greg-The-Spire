...
public class StoreRestSiteOption(Player owner) : RestSiteOption(owner)
{
  ...
  public override string OptionId => "GREGTHESPIRE_STORE";
  
  public string CustomIconPath => "rest_site/store.png".ImagePath();
  ...
  public override LocString Description
  {
   ...
   public override async Task<bool> OnSelect()
   {
     ...
     IEnumerable<CardModel> source = await CardSelectCmd.FromDeckForEnchantment(this.Owner,
       (EnchantmentModel)ModelDb.Enchantment<Stowaway>(), 1, prefs);
