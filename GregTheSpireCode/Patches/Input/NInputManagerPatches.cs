...
using Godot;
using HarmonyLib;
using GregTheSpire.GregTheSpireCode.Config;
...
public static class NInputManagerPatches
{
    ...
    {
        {
            CaptureTarget.StashPile, new BindingEntry(
                () => (GregTheSpireConfig.StashPileModifier, GregTheSpireConfig.StashPileKey),
                binding => (GregTheSpireConfig.StashPileModifier, GregTheSpireConfig.StashPileKey) = binding,
                ModShortcutHelpers.GetStashPile)
        },
        /*
        {
            CaptureTarget.Fire, new BindingEntry(
                () => (GregTheSpireConfig.FireModifier, GregTheSpireConfig.FireKey),
                binding => (GregTheSpireConfig.FireModifier, GregTheSpireConfig.FireKey) = binding,
