...
public class SlipUp() : GregTheSpireCard(1,
    ...
    TargetType.AnyEnemy)
{
        ...
        CardPlay play)
    {
         ...
         CardModel? card = this.Owner.RunState.Rng.CombatCardSelection.NextItem<CardModel>((IEnumerable<CardModel>) StashCardPile.StashPileType.GetPile(this.Owner).Cards);
         if (card == null)
             return;
