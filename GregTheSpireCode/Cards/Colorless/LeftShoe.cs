    ...
    TargetType.AnyEnemy)
{
        ...
        CardPlay play)
    {
        ...
        IReadOnlyList<CardPileAddResult> cardPileAddResultList = await CardPileCmd.Add((IEnumerable<CardModel>) this.Owner.PlayerCombatState.AllCards.OfType<RightShoe>().Where<RightShoe>((Func<RightShoe, bool>) (c =>
        {
